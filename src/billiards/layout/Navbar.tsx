      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden md:block">
          ...
          <input 
            type="text" 
            placeholder="Buscar..." 
            className="py-2 pl-10 pr-4 rounded-lg bg-secondary border border-border focus:outline-hidden focus:ring-2 focus:ring-ring w-full max-w-xs transition-all duration-300"
          />
        </div>
